...
#define LD1_PIN                                GPIO_PIN_13 // USER_LED, was GPIO_PIN_4 (BLUE LED ON NUCLEO)
...
#define LD2_PIN                                GPIO_PIN_10 // GNSS_RESET, was GPIO_PIN_11 (GREEN LED ON NUCLEO)
#endif

#define LD3_GPIO_PORT                          GPIOB
#define LD3_GPIO_CLK_ENABLE()                  __HAL_RCC_GPIOB_CLK_ENABLE()
//#define LD3_PIN                                GPIO_PIN_8
#define LD3_PIN                                GPIO_PIN_11 // Tempering, was GPIO_PIN_8 (RED LED ON NUCLEO)
/**
  * @}
  */
...
#define B1_GPIO_PORT                       GPIOA                        //GPIOC
#define B1_GPIO_CLK_ENABLE()               __HAL_RCC_GPIOA_CLK_ENABLE() //__HAL_RCC_GPIOC_CLK_ENABLE()
#define B1_PIN                             GPIO_PIN_3                   // GNSS_PPS, was GPIO_PIN_13
#define B1_EXTI_LINE                       EXTI_LINE_3                  //EXTI_LINE_13
#define B1_EXTI_IRQn                       EXTI3_IRQn                   //EXTI13_IRQn
...
#define B2_GPIO_PORT                       GPIOA                        //GPIOB
#define B2_GPIO_CLK_ENABLE()               __HAL_RCC_GPIOA_CLK_ENABLE() //__HAL_RCC_GPIOB_CLK_ENABLE()
#define B2_PIN                             GPIO_PIN_6                   // I2C3_SCL
#define B2_EXTI_LINE                       EXTI_LINE_6
#define B2_EXTI_IRQn                       EXTI6_IRQn
...
#define B3_GPIO_PORT                       GPIOA                        //GPIOB
#define B3_GPIO_CLK_ENABLE()               __HAL_RCC_GPIOA_CLK_ENABLE() //__HAL_RCC_GPIOB_CLK_ENABLE()
#define B3_PIN                             GPIO_PIN_7                   // I2C3_SDA
#define B3_EXTI_LINE                       EXTI_LINE_7
#define B3_EXTI_IRQn                       EXTI7_IRQn
/**
  * @}
