  ...
  for (loop = 0 ; loop < ADV_SET_COUNT ; loop++)
  {
    if (adv_set_param[loop].enable != 0)
    {
      ...
      status = aci_gap_set_advertising_configuration(adv_set_param[loop].adv_set.Advertising_Handle,
													 ...
													 HCI_ADV_PHY_LE_CODED, /* Primary advertising PHY */
                                                     0, /* 0 skips */
													 HCI_ADV_PHY_LE_CODED, /* Secondary advertising PHY. Not used with legacy advertising. */
...
static uint8_t ADV_EXT_Build_data(Adv_Set_Param_t *adv_param)
{
  ...
  adv_param->data[data_cpt++] = 11;
  adv_param->data[data_cpt++] = AD_TYPE_MANUFACTURER_SPECIFIC_DATA;
  adv_param->data[data_cpt++] = 0x30; // STMicroelectronis company ID
  adv_param->data[data_cpt++] = 0x01;
  adv_param->data[data_cpt++] = 0x02;
  adv_param->data[data_cpt++] = 0x03;
  adv_param->data[data_cpt++] = 0x04;
  adv_param->data[data_cpt++] = 0x05;
  adv_param->data[data_cpt++] = 0x06;
  adv_param->data[data_cpt++] = 0x07;
  adv_param->data[data_cpt++] = 0x08;
  adv_param->data[data_cpt++] = 0x09;
