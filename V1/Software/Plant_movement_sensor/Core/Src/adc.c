...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  // PA5     ------> ADC4_IN4 ---> BATTERY_LEVEL, this is +BATT or voltage behind resistor
  // PA3     ------> ADC4_IN6 ---> BATTERY_IN,    this is voltage before resistor (resistor of 1R between BATTERY_IN and BATTERY_LEVEL)
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC4_MspDeInit 0 */
    ...
    PA3     ------> ADC4_IN6
    */
    HAL_GPIO_DeInit(GPIOA, SCAP_LEVEL_Pin|BATTIN_LEVEL_Pin|BATT_LEVEL_Pin);
